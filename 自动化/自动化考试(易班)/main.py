...
if __name__ == "__main__":
    ...
    for D in Data['data']:
        ...
        # ?点击进入考试
        wait.until(EC.presence_of_element_located(
            (By.XPATH, '/html/body/div[1]/div/ul/li[4]'))).click()
        # ?XPATH地址
            ...
            if 'exam-paper-' in i:
                ...
                for i in answers['value']['paper']:
                    ...
                    for j in i['subjects']:
                        ...
                        T=wait.until(EC.presence_of_all_elements_located((By.XPATH, '/html/body/div[1]/div[1]/div[2]/main/main/div/div/div/div/div/ul/li')))
                        for anan in an.split(','):
                            T[len(T)-1-int(anan.replace("\"",""))].click()
