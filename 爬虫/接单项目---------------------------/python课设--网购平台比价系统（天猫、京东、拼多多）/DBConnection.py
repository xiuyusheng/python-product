...
class DBConnection:
    ...
    def connect(self):
        ...
        try:
            ...
            cursor.execute('create table goods(goodsID nvarchar(20) Primary key,platform nvarchar(10),title nvarchar(100),shop nvarchar(100),price float,sales nvarchar(10),href nvarchar(300))')
            database.commit()
        except:
            pass
        if database:
    ...
    def save(self,goods):
        ...
        try:
            ...
            cursor.execute('insert into goods values(%s,%s,%s,%s,%d,%s,%s)',
                           (goods.getID(),goods.getPlatform(),goods.getTitle(),goods.getShop(),goods.getPrice(),goods.getSales(), goods.getHref()))
            database.commit()
            database.close()
            return 1
        except:
    ...
    def update(self,goods):
        ...
        try:
            ...
            cursor.execute('update goods set price = %d,sales = %s where goodsID = %s;', (goods.getPrice(),goods.getSales(),goods.getID()))
