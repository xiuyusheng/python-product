        ...
        for j in links_:
            ...
            if key:
                ...
                if key:
                    ...
                    # print(links)
                    folder = os.path.exists(os.path.join('小说',fname))
                    if not folder:
                        os.makedirs(os.path.join('小说',fname))
                    for o,k in enumerate(links):
                        with open(os.path.join('小说',fname,f'第{o+1}章.html').format(fname,o),'w',encoding='utf-8') as f:
